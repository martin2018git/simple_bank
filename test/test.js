var SimpleBank = artifacts.require("../contracts/SimpleBank.sol");
...
it("should transmit events", async () => {
    const bank = await SimpleBank.deployed();

  const expectedEventResult = {accountAddress: alice, amount: 2};
  ...
  const logAccountAddress = log.args.sender;
